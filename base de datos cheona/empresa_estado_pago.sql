...
CREATE TABLE `estado_pago` (
  `id_estap` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `id_factura` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pagado` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pendiente` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id_estap`)
