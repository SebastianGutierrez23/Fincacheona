...
CREATE TABLE `suministra` (
  `id_sumi` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `id_prove` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nom_sumi` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tipo_sumi` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id_sumi`)
